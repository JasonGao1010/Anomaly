...
Date: 2026-09-01 execution identity frozen; the pre-result pilot checkpoint is invalid under the corrected identity and the formal run will restart from seed 0.
