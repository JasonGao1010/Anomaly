...
Execution-freeze commit/hash: Initial runner commit `33244cbaa3a23d1980480e78ddf8f570492eb6ea`; same-score reuse correction `45dd98eb738565b256ca36838e6c34b9d874297e`; current `src/qualify.py` SHA-256 `9f5478dcd758a996c099ca1d18e0069ff82bd66a363f460d54a5c87c5d8140ce`; `src/protocol.py` SHA-256 `070d6899d8a2d26cdf0dacd1dc7dc74d9330a694815aa7afd9b64d6961cddfe6`; `protocol.json` SHA-256 `4092ccb88e7e1661c426f7a984f2780437a5dcd92adbd601784c669f72620d16`. The complete 87-test scientific-semantic suite passed after the implementation correction and before rerun.
Date: 2026-09-02 design and review freeze; descriptive export completed the same day.
Git commit / clean state: The successful export used committed runner `45dd98eb738565b256ca36838e6c34b9d874297e` with only user-owned untracked `PPT/` excluded.
...
Resource and disk preflight: 24 physical CPU cores, RTX 5080 Laptop GPU with 16,303 MiB total and 14,676 MiB free, 20 GiB available RAM, no competing experiment, and Windows E: with 73,971,392,512 bytes remaining of 484,950,659,072 immediately before the successful run. The output used about 58.7 MB; E: retained 73,943,670,784 bytes afterward.
Artifacts and hashes: Directory `runs/ajae/e76_v1`; 27 PLY files plus `manifest.json`; manifest SHA-256 `840b868456958cbdd25e63fa60e6f759c494e215e6ddf6bb33caea95a6b5b755`; total bytes including manifest `58,737,615`. Group A contains 24 PLY files, 1,906,499 vertices and 41,950,889 bytes. Group B contains 3 PLY files, 379,847 vertices and 16,715,208 bytes. Independent parsing reproduced every recorded file hash, property order, vertex count and binary payload size exactly.
...
Primary result: The frozen A worlds were exported in order `[1,2,0,14,8,9]`. The B ranking selected frame 200 with 42 moving-normal points and two-seed statistic `0.041317139536431596`, frame 194 with 67 points and statistic `0.014666997218606384`, and frame 167 with 42 points and statistic `0.01331896943388882`. These are selection outputs, not safety estimates. No PLY was visually interpreted during export or structural verification. The pending visual review must use LiDAR sensor coordinates in metres, black background, point size 2, and orthographic top (`-Z`), front (`+X`) and side (`+Y`) views. One unblinded project-owner reviewer answers the four frozen questions; free orbit is supplemental only.
PASS / FAIL / OUTCOME: OUTCOME — DESCRIPTIVE EXPORT COMPLETE / VISUAL REVIEW PENDING; PASS/FAIL IS FORBIDDEN.
...
Descriptive observations: None yet. File generation and binary validation cannot establish what the geometry looks like.
Notes: Real points are light gray, ignored/background points dark gray, controls blue, proxies red and moving-normal points orange. Group A includes `point_source`; Group B includes moving mask, semantic, range, B0/B1 seed scores and both E76 fold-threshold prediction flags. The first export attempt completed the ranking scan but stopped before atomic output because the runner recomputed the selected frames and imposed an unnecessarily strict cross-forward floating-point equality check. It produced no PLY, manifest or observed visual evidence. The correction retains at most the current top-three score arrays from the original ranking pass and exports those exact arrays; it changes no sample, score formula, threshold or review rule. Public real-OOD and hidden-test sequences remain sealed.
...
1. The authoritative status is E50–E73 PASS. E74 three-seed confirmation is suspended after seeds 0/1; seed 2 is preserved at its exact block checkpoint. E75-X is descriptively complete; E76-X-lite requires scientific safety review; E76-V1's 27 PLY files are exported and structurally verified, with project-owner visual review pending; full E76-X is deferred intact.
2. Gate 1 is closed and formal E75–E77 remain locked. E78-X and B2/B3 seeds 0/1 are also locked because E76-X-lite exceeded the result-blind continuation reference through same-direction moving-normal worsening. E76-V1 can explain that obstacle but cannot remove it or automatically advance the route; no further experiment runs before the visual review and scientific decision.
