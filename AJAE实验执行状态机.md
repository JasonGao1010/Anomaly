...
> Current authoritative baseline: repository `main` and all historical evidence recorded in this document. E50–E58 and E61–E73 have formally PASSed and E59/E60 descriptive characterization is complete. E74's three-seed confirmation is suspended after completed seeds 0/1 with seed 2 preserved at an exact resumable block checkpoint. E75-X completed descriptively. E76-X-lite found a two-seed moving-normal FPR worsening of `0.36463377142417946`. E76-V1's first 27 PLY files were structurally valid but visually invalidated because CloudCompare activates imported scalar fields over RGB by default; an RGB-only viewer-format correction is frozen before rerun. E78-X/B2/B3 remain locked, full E76-X remains deferred, and formal Gate 2 is unadjudicated.
...
Execution-freeze commit/hash: Initial runner commit `33244cbaa3a23d1980480e78ddf8f570492eb6ea`; same-score reuse correction `45dd98eb738565b256ca36838e6c34b9d874297e`; RGB-only CloudCompare compatibility correction `847b9b79c43ca2bed3be1ec0b95e1d42fd98c215`; corrected-node binding `674bf2d1932bebe58db99a2e761c232f6485d74a`; post-rename attribute-size reporting correction `fb7c37165241436d497711e6de566e0187da30bb`. Current `src/qualify.py` SHA-256 is `c50072519d8b943f705d8ca58297c5898ea3c99f25921d801409aca545c7b97a`; `src/protocol.py` and execution protocol remain `6fc33302de76b6063a8715f133247ee5c464c7dfcdb907523210767f73d85d36` and `b79b63477b8d8fd1ff2a0c3545346c88fbc6eea19e5e31fa63fc253643bd2c3d`. The first compatibility launch was rejected before model construction by the stale node guard. The next attempt atomically wrote all outputs but errored only while reading the former temporary attribute path for the final byte-count return; that unadjudicated directory is isolated. The final correction reads the already frozen byte count and changes no output. The focused six-test identity suite passes before rerun.
...
Artifacts and hashes: The first directory `runs/ajae/e76_v1` contained 27 PLY files plus `manifest.json`, manifest SHA-256 `840b868456958cbdd25e63fa60e6f759c494e215e6ddf6bb33caea95a6b5b755`. Its coordinates, RGB bytes, fields, hashes and payload sizes were exact, but it is invalid as a default-view artifact because CloudCompare's PLY loader enables the first imported scalar field after enabling RGB. The corrected output will retain exactly 27 PLY files containing only `x,y,z,red,green,blue`; all former per-point non-display fields move losslessly into one aligned `attributes.npz` archive referenced by the manifest.
...
Primary result: The frozen A world and B-frame selections remain `[1,2,0,14,8,9]` and `[200,194,167]`. The owner's first viewing attempt showed inconsistent blue/rainbow displays. Inspection of the file bytes and CloudCompare's official `PlyFilter.cpp` established that RGB was correct but hidden by automatic scalar-field display. Therefore no appearance observation from that attempt is scientifically valid. The corrected viewer-format rerun is pending.
PASS / FAIL / OUTCOME: OUTCOME — VIEWER IMPLEMENTATION DEFECT / CORRECTED RERUN PENDING; PASS/FAIL IS FORBIDDEN.
...
Descriptive observations: The first visual attempt is invalidated in full; it cannot support any geometry, background or control/proxy interpretation.
