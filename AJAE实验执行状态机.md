...
16. **Exploration and confirmation are separate evidence tracks.** Nodes carrying `-X` use the first two preregistered seeds completed in original order to prioritize whole-method viability. They may report effects and safety but can never PASS Gate 2 or Gate 3. Formal gates retain the original three-seed rules. The 19 public real-OOD and 51 hidden-test sequences stay sealed on both tracks until the confirmatory method freeze permits access.
...
Execution-freeze commit/hash: The execution identity at `c17a433f8acb481b90d5069fe42d30af28760591` was superseded before formal execution because it changed `WorldSpec.seed` during geometry replacement and therefore changed the renderer sensor-noise stream. Corrected runner frozen at `ab98eaecb13534f0bfb6b825f0a6cc37c15ca0d1`; `src/render.py` SHA-256 `c95d1fa631f6900a473f816ed39875e482f2f534ccf928498d9aed36e75aafcb`. This is a pre-result implementation correction, not E58-v2, a protocol change, or an E58 FAIL. The focused E58/cache regression tests passed 4/4 and the complete suite passed 67/67 before this freeze record was written.
Date: Not executed.
Git commit / clean state: Not applicable.
...
Command and resolved config: Training remains AdamW, learning rate 1e-4, weight decay 1e-4, micro-batch 1, gradient accumulation 8, at most 25 complete train/206 worlds per seed, evaluation every 5 worlds, patience 4, and world-type proportions 0.20/0.20/0.40/0.20. B1/B2/B3 share this budget and one checkpoint rule. The 40-to-25 reduction was frozen during E74 before any formal development metric value, loss, or checkpoint-selection result was read; it changes only the future ceiling and retains all completed samples, updates, random states, evaluations and selection rules. Development uses E57 q=0 centers after the identity-only complete `[-4,+2]` common-domain intersection for every B0–B5 condition. Checkpoint selection maximizes macro per-world AP; AP differences below 0.001 tie, followed by lower development macro FPR95, lower pure-normal cross-fit FPR, and earlier checkpoint. Gate 2, both Gate 3 comparisons, optional B4 support, Gate 4, the 0.03 safety limits, strict `score>threshold`, and the nonblocking E59/E60 role are all machine-readable. Gate 3 excludes B4.
...
Experiment ID: E74
Design-freeze commit/hash: E63-v2 selection, evaluation and early-stopping rules remain unchanged; the versioned result-blind E74 budget amendment reduces the common B1/B2/B3 ceiling from 40 to 25 worlds.
Execution-freeze commit/hash: initial implementation `12915657925765ad7c42df09718b1195160ede05`; result-blind neighbor and resume correction `8796785eb4b0a89270715c979575cfb6433233a6`; stable callable identity and qualified attention chunk `bfff99ea8c439b54be56cc7224abc695bbedaab0`; missing runtime import correction `b2353d5dc92ab8191c5c2788ca780ba50836913f`; finite world-report encoding correction `ebec7002f61926a2c2d093cbd04bf41928cbe5f4`; result-blind 25-world budget and exact-prefix transition `f622ec8597a5702326c37dabc6bf6eb4741bd08c`. E57/E63 formal preflight, fixed E57 q=0 B1 evaluator, E61 pure-normal cross-threshold evaluator, deterministic training and resumable block checkpoints are implemented in `src/train.py`, SHA-256 `0b991ed4de35273fa965a2f375d44284df3226f59e62e8e8733b6f014592c9a1`; the exact-neighbor parallel/vectorized model with an 8,192-row attention chunk is `src/model.py`, SHA-256 `b645bb073798ce7352c385c0e6f3a2fcd534d07c00b76e745b6d9a2f0a23c23c`. The complete focused suite passes 78/78 under the amended protocol.
Date: 2026-09-01 execution identity frozen; 2026-09-01 result-blind budget amendment frozen before any formal development metric value was read.
Git commit / clean state: Tracked implementation clean at `ebec7002f61926a2c2d093cbd04bf41928cbe5f4`; untracked user-owned `PPT/` remains excluded.
...
Command and resolved config: Complete seeds 0, 1 and 2 sequentially with deterministic CUDA algorithms, identical B1 configuration and the common 25-world B1/B2/B3 budget. Each evaluation renders the 23 E63-eligible E57 worlds at q=0, reports official-equivalent per-world AP/AUROC/FPR95 and selects checkpoints by E63's macro rule. Fold A and Fold B each provide the official first `TPR>0.95` proxy threshold; the pure-normal tie-break is the mean FPR on the complete 48,828,507-point E61 pure-normal set under those two thresholds, using strict `score>threshold`. Threshold fitting never reads E58 or real-OOD data. The retired `dev.json` is prohibited. Reaching patience or the frozen 25-world ceiling publishes the unique best checkpoint; the ceiling is a valid maximum-budget stop, not an unfinished run. Progress is persisted after each deterministic 16-window block, so interruption recomputes at most one identical block rather than writing a full checkpoint after every window. The one authorized prefix transition must match the frozen B1 seed-0 progress SHA-256, cursor and complete predecessor scientific identity; after that first resumed save, ordinary exact-identity resume applies. A resumed multi-seed invocation validates and skips a complete seed, restores an interrupted seed exactly, and starts any later untouched seed from world zero. PASS requires all three seeds complete, unique selection, unchanged STU identity and complete lineage. Formal continuation command: `python -m src.train --protocol protocol.json --data-root /home/jasongao/Data/STU --condition B1 --max-worlds 25 --device cuda --resume`.
Resource and disk preflight: Rechecked during execution: 24 physical online CPU cores, RTX 5080 Laptop GPU, no competing experiment, and Windows E: with 63,767,052,288 bytes remaining of 484,950,659,072 bytes at the latest check. This remains above the 5% reserve.
Artifacts and hashes: Seed 0 model `892b9f71f0365aa189e8c572f50ac6156dac2773cbbb5f6b862927744890938f`, result `fccc0c513429807eee2580794b7ce01ae0228e6bfb31f5b5f2768c71de01bb22`; seed 1 model `9111c223782e14b0cd90d9bb0f069e5c17bccf54215718250bc548f9a4a17412`, result `fb61b922faae623016a51c09a2f407cee1d9d1b7564d2ebf94acccffcb18e5e5`; seed 2 resumable `progress.pt` `f2a76821755ceb01725756afa43de7b91b1c6c4aff778573e8a6dd19cee65191`.
Primary construct: Complete, comparable B1 training replications under the preregistered budget.
Primary result: Seeds 0 and 1 completed under the unchanged 25-world rule. After their results were observed, the owner explicitly separated rapid whole-method exploration from formal confirmation. Seed 2 was interrupted by `SIGINT` at its last complete deterministic-block checkpoint: world index 2, block index 17, window index 0, 272 completed windows and update index 1170. The progress hash was identical immediately before and after interruption. No partial seed-2 value entered any decision.
PASS / FAIL / OUTCOME: OUTCOME — THREE-SEED CONFIRMATION SUSPENDED; NOT PASS.
Failure classification: None; this is a versioned execution-priority change, not an implementation or scientific failure.
Unlocked next node: E75-X on the exploratory track. Formal E75 remains locked.
Invalidated downstream evidence: None. Formal Gate 2 still requires completion of seed 2 and the original three-seed adjudication.
Descriptive observations: Seed 0 and seed 1 are the first two preregistered seeds in original order, not a performance-selected subset.
Notes: Scientific underperformance is not an invalid-seed mechanical failure. Before any E74 model result, the formal entry still depended on the explicitly retired `dev.json`, and the old 40-world branch refused to publish the already selected best checkpoint as though the budget were incomplete. These were stale implementation semantics. E74 now binds only E57/E63/E73, and both patience and the preregistered maximum-world stop publish through the same unchanged checkpoint selector. The first launch reached seed 0, world 0, deterministic block 2, window 0 (32/449 windows) without completing a world or running a development evaluation. Resource monitoring showed that the serial per-point KD-tree ordering left most CPU/GPU capacity unused, so the process was stopped at that checkpoint before reading any loss or model-quality result. The corrected implementation parallelizes KD-tree queries across the 24 physical cores and vectorizes only strictly ordered rows, while retaining the original stable identity tie-break for every tied row. Against the original algorithm, a processed real 110,302-point frame and a constructed exact-distance-tie fixture had zero neighbor-index and validity-mask differences; the real-frame query fell from 0.689 s to 0.087 s. A second result-blind pilot advanced the same incomplete world to the 96-window checkpoint, then stopped before development evaluation because attention chunks still underused the GPU. On one frozen window, increasing the chunk from 4,096 to 8,192 changed neither loss nor parameter keys, produced maximum gradient difference `3.725290298461914e-09` and maximum post-AdamW parameter difference `2.9802322387695312e-08`, both below the existing `1e-7` reproduction tolerance; forward/backward time fell from 0.958 s to 0.615 s and peak allocation rose only from 11,040.8 to 11,059.0 MiB. The pilot also exposed that Python `-m` execution encoded the same evaluator callable as `__main__` whereas import encoded `src.train`; the corrected implementation canonicalizes the installed module identity. Therefore the old pilot checkpoint is implementation-invalid and is discarded rather than rewritten or resumed. The first post-bind restart then stopped during identity construction with `NameError: sys is not defined`, before model construction, any training window, or artifact creation; commit `b2353d5` adds the omitted import and a direct regression test, without changing the identity rule. After the first valid world completed, world 1 construction exposed one valid positive-infinity obstacle-clearance sentinel when no observed obstacle existed; strict JSON rejected that report before training the world. Commit `ebec700` encodes only this mathematically valid sentinel as JSON `null`, while every other non-finite report value remains forbidden. The later result-blind efficiency amendment was made after four scheduled development evaluations had been computed but before any of their values, any training loss, or any checkpoint-selection result was read. Because the previous 40-world ceiling could not affect the already realized prefix, the exact B1 seed-0 checkpoint at world index 22, block 15 is reused after checking its file hash and reconstructing its complete predecessor identity; only the future ceiling changes to 25 for B1/B2/B3. No general cross-protocol resume path is permitted. These changes leave samples, neighbor identities, random streams, formulas, evaluator and thresholds unchanged.

## E74-X | B1 Exploratory Cohort

Experiment ID: E74-X
Design-freeze commit/hash: Exploration/confirmation split frozen after seeds 0/1 results were observed; it may change execution priority but cannot change any formal three-seed threshold.
Execution-freeze commit/hash: Seed artifacts and paused seed-2 progress identities above.
Date: 2026-09-02.
Git commit / clean state: Seed-2 resume code/protocol preserved on remote branch `confirm/e74-seed2-resume`; user-owned `PPT/` excluded.
Data identities: Exactly seeds 0 and 1, the first two preregistered seeds completed in original order.
Input artifact hashes: E74 seed 0/1 model and result hashes above.
Random namespaces / seeds: 0 and 1 only; no performance-based seed selection.
Command and resolved config: Reuse the completed artifacts; do not retrain, truncate or inspect partial seed 2.
Resource and disk preflight: No new computation.
Artifacts and hashes: Same seed 0/1 E74 artifacts.
Primary construct: A fixed two-seed exploratory cohort for rapid whole-method viability testing.
Primary result: Both cohort members completed under identical E63-v2 training and checkpoint rules.
PASS / FAIL / OUTCOME: OUTCOME — EXPLORATORY COHORT COMPLETE; NOT A FORMAL GATE RESULT.
Failure classification: None.
Unlocked next node: E75-X.
Invalidated downstream evidence: None; formal E74 remains suspended.
Descriptive observations: None beyond the model results evaluated in E75-X.
Notes: Every later B1/B2/B3 exploratory comparison must use both seeds 0 and 1.

## E75-X | Exploratory B1 versus B0 Effect
...
Date: 2026-09-02 result-blind route and sample freeze; formal exploratory execution complete the same day.
Git commit / clean state: Execution used the tracked correction identity above from a clean tracked worktree; untracked user-owned `PPT/` remained excluded.
...
Resource and disk preflight: 24 physical CPU cores, RTX 5080 Laptop GPU with 16,303 MiB total and 14,405 MiB free, 20 GiB available RAM, no competing experiment, and Windows E: with 73,978,929,152 bytes remaining of 484,950,659,072 before execution. The run used about 4.5 GiB GPU memory and 4.4 GiB host memory and completed in 494.231 seconds. The selected 64 frames contain exactly 3,955,039 pure-normal points, 8.10% of the complete 48,828,507-point set.
Artifacts and hashes: `runs/ajae/e76x_lite_b1_safety.npz`, SHA-256 `0826724f6939afaadf0d097c4359ced1f61eb6b6f114211306ef437a832c99c7`; scientific-array SHA-256 `2bab9994dd32a9be85448b73926da7f7ec52c045c00ee158f3f0f406f52d7f5f`; execution-time protocol SHA-256 `30434c141cc4ca535808f5996dde9bf8ec98b6656c75047f41b697d15b27d4a9`. Frozen ordered frame IDs: `[288,302,673,505,572,111,332,635,258,464,589,504,681,443,201,592,99,45,602,502,401,265,415,106,196,87,354,10,652,536,603,391,406,672,663,343,494,271,234,110,294,121,562,148,468,125,540,251,416,616,33,594,526,633,636,523,541,359,363,476,317,533,608,51]`; canonical selection SHA-256 `d8c2989066d4352182fe998758018631fb493be67a825fa1cffac10a333133ad`.
...
Primary result: In measure order `[pure-normal FPR, normal-control FPR, moving-normal FPR, development FPR95]`, B0 was `[0.8388513994, 0.8859360610, 0.5114902775, 0.3711824258]`; B1 seed 0 was `[0.1888669113, 0.9998684384, 0.9905464607, 0.0768848033]`; B1 seed 1 was `[0.2764086524, 0.6036047888, 0.7617016371, 0.0693611408]`. The two-seed mean signed worsenings were `[-0.6062136176, -0.0841994474, 0.3646337714, -0.2980594538]`. Moving-normal worsening was positive in both seeds: `+0.4790561832` and `+0.2502113596`.
PASS / FAIL / OUTCOME: OUTCOME — SCREEN COMPLETE / SAFETY REVIEW REQUIRED; NOT A FORMAL E76 OR GATE 2 VERDICT.
...
Unlocked next node: None. E78-X and all B2/B3 exploratory training are locked by the prespecified continuation rule.
...
Execution-freeze commit/hash: Initial runner commit `33244cbaa3a23d1980480e78ddf8f570492eb6ea`; same-score reuse correction `45dd98eb738565b256ca36838e6c34b9d874297e`; initial RGB compatibility changes `847b9b79c43ca2bed3be1ec0b95e1d42fd98c215`, `674bf2d1932bebe58db99a2e761c232f6485d74a`, and `fb7c37165241436d497711e6de566e0187da30bb`; final lossless-source correction `cc9ea758af08526fa3f52e7cae3ce651a6407318`. The successful correction used `src/qualify.py` SHA-256 `85ff378afab2e5d049e5561e5918a3d2b5bc82a577196648506657417fe973c5` and execution protocol SHA-256 `401bd028b13369b13abbaf6b7e867b0dcb5e6d03dd4f07d52b988bf4c3c73a8f`. The complete test suite passed before execution. The first compatibility launch was rejected before model construction by a stale node guard, and a later attempt completed atomic output creation but failed only in return-value reporting. Independent comparison then found that fresh STU/model evaluation does not reproduce the original B-group scores bitwise. Because this task changes display representation only, the authoritative runner was simplified to repackage the frozen first export and model recomputation is now forbidden.
Date: 2026-09-02 design and review freeze; descriptive export completed the same day.
Git commit / clean state: The successful correction used committed runner `cc9ea758af08526fa3f52e7cae3ce651a6407318` with only user-owned untracked `PPT/` excluded.
...
Command and resolved config: `python -m src.qualify e76v1 --protocol protocol.json --source-dir runs/ajae/e76_v1_source --output-dir runs/ajae/e76_v1`. The source directory is the frozen first export whose manifest SHA-256 is `840b868456958cbdd25e63fa60e6f759c494e215e6ddf6bb33caea95a6b5b755`. The runner verifies every source PLY hash, reads each vertex property without conversion, writes only `x,y,z,red,green,blue` to the corresponding viewer PLY, and stores every remaining property in the aligned `attributes.npz` archive. No renderer, STU encoder, B1 model, selection or threshold is rerun.
...
Execution-freeze commit/hash: Initial CPU-only runner commit `790400f9f302218283c7457d3de6577292fbd017`; immutable-mask implementation correction `e0b0c185961a5709708e6500206ef58510976f37`, with `src/render.py` SHA-256 `18986d3fe1e8fa43bf6a237dc4e5538f229a3bcfe4be8d0ef67a3feae0938955`; frozen protocol SHA-256 remains `00f8959ec2c483c0c1a683cc72a0380c253f80dc25ee8070be2c3f69262e4098`. The first launch stopped before any result aggregation or artifact write because the runner attempted an in-place operation on a read-only renderer mask. The correction only allocates a new boolean array and changes no sample, return, metric, model, threshold or random identity. The complete 90-test scientific-semantic suite passed before the first launch, and all focused E76-C1 tests passed after the correction.
Date: 2026-09-02 design freeze and formal execution.
Git commit / clean state: Formal execution used the tracked corrected runner and frozen protocol with only user-owned untracked `PPT/` excluded.
...
Resource and disk preflight: 24 physical CPU cores, 20 GiB available RAM, no competing experiment, and Windows E: with 73,838,354,432 bytes remaining of 484,950,659,072. GPU was not used. The formal replay and scalar audit completed in about 47 seconds and wrote 129,169 bytes.
Artifacts and hashes: `runs/ajae/e76_c1_visible_clearance.npz`; SHA-256 `d82485fd830034d065bb9156ec0ec130c57076a730bd2ecba281573aeed1a216`; scientific-array SHA-256 `25d8ac747ed01712be8f2e2d06f0a73caaa3c42236206c8b8c3443e4a22e8641`.
...
Primary result: Across all 1,347 pairs, control clearance min/q05/q25/q50/q75/q95/max was `[0.001687,0.010700,0.031108,0.068296,0.131193,0.228113,0.911506] m`; proxy clearance was `[0.001255,0.012302,0.032656,0.061933,0.111688,0.198664,0.463796] m`. The paired control-minus-proxy mean and median were `0.012711 m` and `0.001050 m`; `50.63%` were positive, `25.69%` exceeded 5 cm and `12.99%` exceeded 10 cm. The logistic model's pooled AUC/BA was `0.519495/0.527100`, with lower bounds `0.483539/0.497290`. The tree's pooled AUC/BA was `0.501256/0.532520`, with lower bounds `0.467819/0.504065`. Neither model triggered the branch.
PASS / FAIL / OUTCOME: OUTCOME — `NO DIRECT CLEARANCE DEGENERACY DETECTED`. This means clearance alone did not nearly solve the frozen label task; it does not mean the two distributions are identical or that clearance cannot influence a larger model.
...
Unlocked next node: AJAE-F0-X. E78-X/B2 remains a deferred ablation until whole-method viability is supported.
...
## AJAE-F1-X | Full-First v4 Entry and B3 Seed0

Status: P1 frozen result-blind; P2 execution complete PASS; B3 seed0 training unlocked. P1 and P2 are entry prerequisites inside AJAE-F1-X, not additional scientific experiment nodes. No B3 training or performance result has yet been produced.

P1 keeps the formal B2/B3 prediction target at q=0. Train/201 pure-normal safety is therefore the frozen E61 identity intersection on frames 6–679: 48,638,267 points, excluding the 190,240 boundary points that have no legal q=0 window. Train/206 moving-normal safety is frames 2–446: 12,820 points, excluding 191 boundary points. The existing 64-frame lite selection retains its 63 legal frames and does not replace frame 681. B4 retains every frozen E61 identity with at least one legal window occurrence and additionally reports full-domain safety. Any paired safety difference uses the exact intersection of the two models' formal point-identity domains.

P2 freezes seed0's first mixed world in the existing cycle: world index 2, world seed `1027531`. Its first formal shuffled window is center frame 2 over frames `[0,1,2,3,4]`. This identity was derived without model output or window search; a read-only renderer check found 590 normal-control and 3,833 anomaly-proxy visible returns, and the existing B1 world-report hash remained unchanged.

The one-step command is `python -m src.train --protocol protocol.json --data-root /home/jasongao/Data/STU --condition B3 --max-worlds 25 --device cuda --semantic-preflight-output runs/ajae/ajae_f1_x_semantic_preflight.npz`. Execution-freeze commit: `b3962c6a8e5b6cfe3bca5bb3a27cbec14bc66581`; protocol SHA-256 `9afd77019facc69743f4506a5be44f82e1d35f788f2d635c1bdaae542a45232f`; `src/train.py` SHA-256 `afb20ac26d1d2b872892c01992b9156bc3e8c078f72288969a6fea044de8f3b7`; complete regression `90 passed`. Resource preflight: 24 physical CPU cores, 20 GiB available RAM, 16 GiB unused swap, RTX 5080 Laptop GPU with 16,303 MiB total / 14,579 MiB free and 6% utilization, Windows E: 73,839,403,008 bytes remaining of 484,950,659,072, no competing AJAE experiment, and target artifact absent. It uses the production renderer, frozen STU, formal five-frame `WindowTrainingData`, B3, authoritative balanced BCE, backward, gradient clipping and one AdamW step. PASS requires: exact proxy/control/real-normal targets; all five q positions supervised; exact balanced BCE semantics; no STU gradient or parameter change; at least one AJAE parameter update; positive finite cross-gate anomaly-loss gradient; and at least one finite q=0 logit changed by enabling cross-frame messages. Failure is `implementation_defect` only and must be repaired on this same input and rule.

The first formal invocation reached the fixed window but stopped during the cross-frame forward before any of the seven checks was adjudicated or any artifact was written. CUDA reported `device not ready`, while the WSL kernel reported `dxgkio_make_resident: Ioctl failed: -12`; the target artifact remained absent. This is a runtime-memory implementation defect, not a P2 result. Correction commit `ab650d5290d79f8e5cd9d4fc7792eff9a78d682e` keeps the exact computation and adds activation recomputation only for cross-frame training plus release of unused CUDA cache after the no-cross control forward. A direct regression found elementwise-identical outputs and every named parameter gradient against the original graph; the complete suite passed `91 passed`. Corrected source SHA-256: `src/model.py` `821e4ef0ca8aebcbb73f94f4df39619309a217ab1c3a1b89390883e9ffce556c`; `src/train.py` `a7639fff53bd547de9a111932fd9bbc93442c932beeb06968e4315bd92894534`; `test_ajae.py` `b58175d23fe05c565de1104f5308ca6fac0790bf34f54453bc2511e67ffaf944`. The protocol hash, input identity, seven checks and command remain unchanged; the same P2 must be rerun.

The second invocation completed the full cross-frame forward but encountered the same WSL residency error while reconstructing one attention branch in backward; again no artifact or adjudication was produced. Correction commit `ed710e962ed491a7a677243cb2f8d25131efad16` additionally recomputes each neighbor-attention chunk during backward so that the five branches do not retain all local tensors simultaneously. A multi-chunk regression found outputs and named parameter gradients elementwise identical to the non-checkpointed path, and the complete suite again passed `91 passed`. Current corrected SHA-256: `src/model.py` `396b40cec1dc5f065188c011f740546e30818d1e725713a4e7072a1dbea54576`; `src/train.py` `a7639fff53bd547de9a111932fd9bbc93442c932beeb06968e4315bd92894534`; `test_ajae.py` `1db140f4a0eb6bcb11d51ffcd36998f80d342a86c07276c8c39d608f9746b9fd`. P2 remains pending on its original frozen input and rules.

The third invocation on commit `dd07df34bb260ce919ca148d8984eb7a664b80b5` completed and PASSed. Artifact `runs/ajae/ajae_f1_x_semantic_preflight.npz` is 5,132 bytes with SHA-256 `07a86fd71a94398aa829a1059b3516962ec0804a0df9c5686f7e97a97f373f6b` and scientific-array SHA-256 `1d2aec9e53c00fbe94d82a86d261565a9da456b531f5872126fda84ae534a87f`. Every one of the seven error counts is zero; all five q positions are present with positive valid counts; targets contain exactly 590 controls and 3,833 proxies; STU before/after SHA-256 is identical; AJAE before/after SHA-256 differs; all 16 recorded cross-gate gradient norms are finite and positive; and 123,544 q=0 logits change when cross-frame messages are enabled. Peak allocated GPU memory was 14,855,744,000 bytes and the measured CUDA section took 22.262 seconds. This is an implementation PASS only; `model_quality_evaluated=false`.

Run B3 seed0 with `python -m src.train --protocol protocol.json --data-root /home/jasongao/Data/STU --condition B3 --max-worlds 25 --device cuda --seed 0`. The selected-seed option changes only which preregistered seed is executed now; seed identity and all scientific settings remain frozen. The run retains the existing 25-world ceiling, five-world development cadence, patience four, optimizer, world cycle, 23 development worlds and checkpoint-selection rule. B4 may only reuse the selected B3 checkpoint; B4, moving-normal rescue or other safety results may not select the checkpoint.

The first B3 seed0 process on commit `97138fc` completed its first shuffled block of 13 windows and atomically saved cursor `world_index=0, block_index=1, window_index=0, windows_completed=13, update_index=13`. It then encountered `CUDA driver error: device not ready` during backward in the next 16-window block; WSL simultaneously recorded `dxgkio_make_resident: Ioctl failed: -12`. The failed block was never committed, no development evaluation had occurred, and no loss or performance value was read for the repair decision. Progress artifact `runs/ajae/B3/seed-0/progress.pt` is 14,401,441 bytes with SHA-256 `1a5a676b292d961e0d4a04f4052238513deb05e7a0daceec77087da0b333ef6a`. This is an execution-memory defect, not a B3 scientific result. Correction commit `0c53d8d369fadb695f7d7fae18fe55f60b2fec1f` synchronously stores tensors already saved for backward in host memory and returns their exact values to the unchanged CUDA graph when needed. Asynchronous pinned-memory transfer was explicitly rejected after it produced gradient differences up to `2.384185791015625e-7`; the adopted synchronous path reproduced logits and all 137 named parameter gradients elementwise exactly. The complete regression passed `92 passed`; corrected SHA-256: `src/train.py` `69c879675b14eab38d4c6ae253e5bb2d7e810e8ceeddb928812ad1af3d0e6bc1`, `test_ajae.py` `18fed8d4ab10d5aa6c5cc846942be05cfce3409921be0a73007ff7eef069fce0`. Resume the same run with the original command plus `--resume`; the failed block must be recomputed from its pre-block checkpoint.

The corrected resume completed the previously failing block and the following block, advancing exactly to `world_index=0, block_index=3, window_index=0, windows_completed=45, update_index=45`. Host offload reduced active GPU allocation but freed host buffers were retained by the Linux process heap, and swap occupancy increased monotonically from 174 MiB to 388 MiB. To prevent a multi-day run from relying on swap, the process was interrupted immediately after the 45-window atomic recovery point; the next block had begun but was not committed, and no performance statistic was read. Progress SHA-256 at that point is `41063e7c573b225575a9db10446fdf1d61b8981b9a91ce6e89204c55939ee343`. Correction commit `8c66994140a405cc94a72e5742a881ad9e82eedc` deletes completed-window graph references and returns freed offload heap pages to Linux only after backward and loss capture. It does not participate in model, loss, gradient or optimizer calculation. The complete suite passed `93 passed`; corrected SHA-256: `src/train.py` `117645f180ba322675548f8b826f75a0de80a6522109180d59d1a5667c78f3e4`, `test_ajae.py` `5087b591553785ae4bb71aa21427b9431546e7cbcb4b84df84b391870c24126d`. Resume again from the unchanged 45-window recovery point and verify that resident memory and swap growth remain bounded.

That release-only validation was stopped before a new block commit because one window still raised swap occupancy from 356 MiB to 819 MiB; the 45-window progress artifact remained unchanged and no scientific statistic was read. Read-only tracing of the actual next window, center frame 306 with 635,693 points, found 148 saved-tensor calls totaling 11,409,200,764 bytes. Full-graph offload was therefore the source of host pressure. Correction commit `37891f5a2efc89f6a071c9e14923dbb692663fea` replaces it with synchronous call-ordered offload capped at exactly 2 GiB per window. On the traced graph this transfers 2,147,483,396 bytes and completely releases 2,155,898,720 bytes of independent GPU storage, while retaining every sample and operation. No snapshot is reused after a rejected implementation demonstrated address-reuse corruption in a pre-execution regression. The adopted bounded path again reproduced logits and every named parameter gradient elementwise exactly; the complete suite passed `93 passed`. Corrected SHA-256: `src/train.py` `b2c28c74b1575e3866626ec211f28987e8f7b4d632b16a81a435b12a9c1c90f0`, `test_ajae.py` `2f3388e971016254e9d3a4dd2f456b0551fbf10464e567a0f2be21521878375e`. Resume from the same 45-window checkpoint and require both a new block commit and bounded host/swap behavior before leaving it unattended.
