...
$$
\boxed{E25\text{-v2 FAIL RETAINED};\quad D_{xy}+\alpha\ \text{ABANDONED};\quad E25\text{-v3 PLANE DIAGNOSTIC FROZEN}}
$$
...
E27–E44已关闭；E36-v1、E45-v1、E45-v2、E45A、E45A-v2和E25-v2 FAIL均保留。旧E45B已PASS，但只资格旧normal-control分布；任何新版正式control分布必须重新执行E45B-v2。$D_{xy}+\alpha$路线已经终止；E25-v3支撑平面相容性只读诊断的输入、搜索顺序和两项继承物理界限已经冻结，当前尚未运行。E26-v2、E46和E48保持锁定。
