...
$$
\boxed{E25\text{-v2 FAIL RETAINED};\quad D_{xy}+\alpha\ \text{ABANDONED};\quad E25\text{-v3 PLANE DIAGNOSTIC COMPLETE, TARGET BANK NOT FROZEN}}
$$
...
E27–E44已关闭；E36-v1、E45-v1、E45-v2、E45A、E45A-v2和E25-v2 FAIL均保留。旧E45B已PASS，但只资格旧normal-control分布；任何新版正式control分布必须重新执行E45B-v2。$D_{xy}+\alpha$路线已经终止；E25-v3支撑平面相容性只读诊断已经完成并核验，但当前两项条件仍接受大量不具局部性的远距离patch，因此目标库没有冻结。当前停在“可信局部支撑平面”的操作定义需要重新决策的位置，E26-v2、E46和E48保持锁定。
