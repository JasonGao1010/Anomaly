...
E75在任何E74正式开发指标值被读取前完成了统计身份实现补全。E63历史产物的bootstrap仍从原始24个E57身份抽样，但B0/B1共同域只包含23个世界，因此旧数组有3,229/5,000个replicate抽到不可配对的`world_id=5`，共5,037次。该问题不改变科学门槛，也不要求重跑E63。经课题负责人批准，E75固定使用`E75-common-domain-bootstrap-correction-v1`：NumPy PCG64种子仍为`63002026`，每次有放回抽取3个训练种子和23个共同域世界，B1/B0共享同一实现索引，共5,000次。新身份保留原E63的5,000×3 seed抽样逐元素不变，`world_id=5`出现次数为0；独立复算逐元素一致。身份产物`runs/ajae/e75_bootstrap_identity.npz`为91,013字节，SHA-256为`1bae1dbe4b5ded34cf9cebd818b4877368973114c0e7046840c0ff342fb73b9d`，科学数组哈希为`deac90b297fd84e4c3d5cde7c2d5d57a139f9d0a1aba85e3539c564f2ec50869`。该补全不称E75-v2，不改变25 worlds/seed预算、2.5%下界、0.02效应门槛或2/3 seed方向规则。
